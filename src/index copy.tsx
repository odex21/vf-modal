...
interface DialolgRunConfig<T extends DialogTypesAGroup> {
...
const dialog = <T extends DialogTypesAGroup> (dialogTypes: T, config: DialolgRunConfig<T>) => {
  const {
    transitionName = 'fade',
    type,
  ...
  const instance = new Component({
    ...
    render: function (h) {
      const customNode = filter(e => !!(typeof e !== 'string' && e.component), customList) as DiaglogKeyC[]
